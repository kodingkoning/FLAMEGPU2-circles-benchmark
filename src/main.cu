...
bool experiment_total_scale_all(custom_cli cli){
    ...
    const std::vector<float> TARGET_ENV_VOLUMES = {10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 200000, 300000, 400000, 500000, 600000, 700000, 800000, 900000, 1000000, // up to 1M
                                                   2000000, 3000000, 4000000, 5000000, 6000000, 7000000, 8000000, 9000000, 10000000, // up to 10M
                                                   10**8, 2*10**8, 3*10**8, 4*10**8, 5*10**8, 6*10**8, 7*10**8, 8*10**8, 9*10**8, 10**9, // up to 1B
                                                   11*10**8, 12*10**8, 13*10**8, 14*10**8, 15*10**8, 16*10**8, 17*10**8, 18*10**8, 19*10**8, 20*10**8 // up to 2B
                                                   };
...
bool experiment_high_density(custom_cli cli){
    // Name the experiment - this will end up in filenames/paths.
    const std::string EXPERIMENT_LABEL="high-density";
...
bool experiment_profiling(custom_cli cli) {
    // Name the experiment - this will end up in filenames/paths.
    const std::string EXPERIMENT_LABEL="profiling";
